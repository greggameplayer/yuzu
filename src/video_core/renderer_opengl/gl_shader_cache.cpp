...
static bool IsSchedInstruction(u32 offset, u32 main_offset) {
    ...
    const u32 absolute_offset = offset - main_offset;
    return (absolute_offset % SchedPeriod) == 0;
}

static std::size_t CalculateProgramSize(GLShader::ProgramCode program) {
    const u32 start_offset = 10;
...
void CachedShader::CalculateProperties() {
    ...
    if (program_type == Maxwell::ShaderProgram::VertexA) {
        ...
        setup.program.unique_identifier = seed;
    }
}
